...
public class FrmFactura extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        TblAgregar.addContainerListener(new java.awt.event.ContainerAdapter() {
            public void componentAdded(java.awt.event.ContainerEvent evt) {
                TblAgregarComponentAdded(evt);
            }
        });
        TblAgregar.addHierarchyListener(new java.awt.event.HierarchyListener() {
            public void hierarchyChanged(java.awt.event.HierarchyEvent evt) {
                TblAgregarHierarchyChanged(evt);
            }
        });
        TblAgregar.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                TblAgregarAncestorAdded(evt);
            }
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
                TblAgregarAncestorMoved(evt);
            }
        ...
        TblAgregar.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                TblAgregarMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                TblAgregarMouseExited(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                TblAgregarMouseReleased(evt);
            }
        });
        TblAgregar.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentHidden(java.awt.event.ComponentEvent evt) {
                TblAgregarComponentHidden(evt);
            }
            public void componentMoved(java.awt.event.ComponentEvent evt) {
                TblAgregarComponentMoved(evt);
            }
            public void componentResized(java.awt.event.ComponentEvent evt) {
                TblAgregarComponentResized(evt);
            }
            public void componentShown(java.awt.event.ComponentEvent evt) {
                TblAgregarComponentShown(evt);
            }
        });
        TblAgregar.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                TblAgregarInputMethodTextChanged(evt);
            }
        });
        TblAgregar.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                TblAgregarPropertyChange(evt);
            }
        });
        TblAgregar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TblAgregarKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                TblAgregarKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                TblAgregarKeyTyped(evt);
            }
        });
        TblAgregar.addVetoableChangeListener(new java.beans.VetoableChangeListener() {
            public void vetoableChange(java.beans.PropertyChangeEvent evt)throws java.beans.PropertyVetoException {
                TblAgregarVetoableChange(evt);
            }
        });
        ...
        BtnAgregarProducto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnAgregarProductoKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
        ...
        TxtCantidad.setMinimumSize(new java.awt.Dimension(0, 0));
    ...
    private void BtnAgregarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgregarProductoActionPerformed
        // TODO add your handling code here:
         ...
         if (TxtNumFac.getText().equals("") || TxtNumProducto.getText().equals("") || TxtCantidad.getValue().equals(0)){
             ...
             banera = false;
         }/*else if (verificar2() == 1){
             //JOptionPane.showMessageDialog(this, "No puede hacer eso")
             JOptionPane.showMessageDialog(this, "No puede insertar 2 veces el mismo número de producto, haga doble click sobre el nuevo registro en la tabla y digite de nuevo la cantidad que desea comprar");
...
//GENERAR VENTA AQUIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         if (TxtNumFac.getText().equals("") || TxtNumProducto.getText().equals("") || TxtCantidad.getValue().equals(0) ||TxtIdClient.getText().equals("") || TxtIdTrabajador.getText().equals("")){
             JOptionPane.showMessageDialog(this, "Faltan datos");
         }else if(TblAgregar.getRowCount() ==0 || TxtMontoPagar.getText().equals(0.0)) {
             JOptionPane.showMessageDialog(this, "Faltan datos");
         }
         else{
               guardarFactura();
    ...
    public int verificar2(){
        int num =0;
            ...
            for (int i = 0; i < TblAgregar.getRowCount(); i++) {
                ...
                if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
                    //JOptionPane.showMessageDialog(this, "NO");
                    //int cant = Integer.parseInt(TblAgregar.getValueAt(i, 3).toString());

                   // TblAgregar.setValueAt(cant + 1, i, 3);
                    num = 1;
    ...
    private void TxtCantidadKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TxtCantidadKeyTyped
        ...
        if(Integer.parseInt( TxtCantidad.getValue().toString()) <  0){
            JOptionPane.showMessageDialog(this, "No puede digitar números negativos");
        }
    ...
    private void TxtCantidadStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_TxtCantidadStateChanged
        // TODO add your handling code here:
        if(Integer.parseInt( TxtCantidad.getValue().toString()) <=  0){
            JOptionPane.showMessageDialog(this, "Debe de elegir una cantidad válida");
            TxtCantidad.setValue(1); 
        }
    ...
    private void TblAgregarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TblAgregarKeyTyped
        // TODO add your handling code here:
//        for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarKeyTyped

    private void TblAgregarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblAgregarMouseEntered
        // TODO add your handling code here:
//         for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarMouseEntered

    private void TblAgregarPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_TblAgregarPropertyChange
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarPropertyChange

    private void TblAgregarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TblAgregarKeyReleased
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarKeyReleased

    private void TblAgregarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TblAgregarKeyPressed
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarKeyPressed

    private void TblAgregarMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblAgregarMouseReleased
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarMouseReleased

    private void TblAgregarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblAgregarMouseExited
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarMouseExited

    private void TblAgregarInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_TblAgregarInputMethodTextChanged
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarInputMethodTextChanged

    private void TblAgregarAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_TblAgregarAncestorAdded
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarAncestorAdded

    private void TblAgregarAncestorMoved(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_TblAgregarAncestorMoved
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarAncestorMoved

    private void TblAgregarComponentAdded(java.awt.event.ContainerEvent evt) {//GEN-FIRST:event_TblAgregarComponentAdded
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarComponentAdded

    private void TblAgregarHierarchyChanged(java.awt.event.HierarchyEvent evt) {//GEN-FIRST:event_TblAgregarHierarchyChanged
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarHierarchyChanged

    private void TblAgregarComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_TblAgregarComponentResized
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarComponentResized

    private void TblAgregarComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_TblAgregarComponentShown
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarComponentShown

    private void TblAgregarComponentMoved(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_TblAgregarComponentMoved
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarComponentMoved

    private void TblAgregarComponentHidden(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_TblAgregarComponentHidden
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarComponentHidden

    private void TblAgregarVetoableChange(java.beans.PropertyChangeEvent evt)throws java.beans.PropertyVetoException {//GEN-FIRST:event_TblAgregarVetoableChange
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_TblAgregarVetoableChange
...
//        }
    ...
    private void BtnAgregarProductoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAgregarProductoKeyPressed
        // TODO add your handling code here:
//          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
//
//            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
...
//            }
//        }
    }//GEN-LAST:event_BtnAgregarProductoKeyPressed
    ...
    private void BtnAgregarProductoMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnAgregarProductoMouseEntered
        // TODO add your handling code here:
          for (int i = 0; i < TblAgregar.getRowCount(); i++) {
            ...
            if (Integer.parseInt(TxtNumProducto.getText()) == Integer.parseInt(TblAgregar.getValueAt(i, 1).toString())) {
                JOptionPane.showMessageDialog(this, "No puede insertar 2 veces el mismo número de producto, haga doble click sobre el registro que desea editar y digite de nuevo la cantidad que desea comprar");
                //int cant = Integer.parseInt(TblAgregar.getValueAt(i, 3).toString());
...
//        }
    ...
    void guardarDetalleFactura(){
        ...
        for (int i = 0; i < TblAgregar.getRowCount(); i++) {
            ...
            Float precioT = Float.parseFloat(TblAgregar.getValueAt(i, 4).toString());
    ...
    void verificar(){
        String nump = TxtNumProducto.getText();
        for(int i=0; 1< TblAgregar.getRowCount(); i++){
            int n = TblAgregar.getColumnCount();
            if(TblAgregar.getValueAt(i, n).equals(nump)){
